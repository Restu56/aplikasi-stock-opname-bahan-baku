        ...
        <table class="table table-bordered table-striped" id="exportmasuk" width="100%" cellspasing="0">                   
            ...
            if(isset($_POST['filtertglmasuk'])){
                ...
                if($mulai != null || $akhir != null){
                    ...
                    tanggal BETWEEN  '$mulai' and '$akhir' order by idkeluar DESC"); 
                } else {
                    $ambilsemuadatastock = mysqli_query($conn, "select * from keluar k, stock s  where s.idbarang = m.idbarang  ORDER BY idkeluar DESC");
                }
